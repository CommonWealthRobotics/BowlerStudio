...
public class MySwingNode extends SwingNode {
  ...
  void setImageBuffer(
    ...
    try {
      ...
      super.setImageBuffer(data, x, y, w, h, linestride, scale);
    } catch (Exception ex) {
      ex.printStackTrace();
    }
  }
  ...
  /**
   * Returns the {@code SwingNode}'s minimum width for use in layout calculations. This value
   * corresponds to the minimum width of the Swing component.
   *
  ...
  /**
   * Returns the {@code SwingNode}'s minimum height for use in layout calculations. This value
   * corresponds to the minimum height of the Swing component.
   *
