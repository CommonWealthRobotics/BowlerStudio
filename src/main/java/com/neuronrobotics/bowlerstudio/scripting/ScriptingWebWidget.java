...
public class ScriptingWebWidget extends BorderPane implements ChangeListener<Object> {
    ...
    private String addr;
    private boolean loadGist = false;

    private ScriptingWidgetType type;

    private final ComboBox<String> fileListBox = new ComboBox<>();
    ...
    public ScriptingWebWidget(ScriptingWidgetType type) {
        ...
        runfx.setOnAction(e -> new Thread(this::startStopAction).start());
        edit.setOnAction(e -> new Thread(() -> {
