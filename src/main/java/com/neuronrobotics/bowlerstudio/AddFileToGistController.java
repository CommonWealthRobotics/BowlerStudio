...
public class AddFileToGistController extends Application {
  ...
  @FXML public Button addFileButton, cancelButton;
  @FXML private ComboBox<String> extention;
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    extention.setOnAction(
        event -> {
          try {

            langaugeIcon.setImage(AssetFactory.loadAsset(asset));
            ...
            () -> {
              ...
              try {
                ScriptingEngine.pushCodeToGit(
                    gitRepo,
                    ScriptingEngine.getFullBranch(gitRepo),
                    text,
                    "//Your code here",
                    message);
