...
public class DhSettingsWidget extends javafx.scene.Group implements IOnEngineeringUnitsChange {
  ...
  public DhSettingsWidget(
      DHLink dhLink, DHParameterKinematics device2, IOnEngineeringUnitsChange externalListener) {
    this.dhLink = dhLink;
  ...
  public void onSliderMoving(EngineeringUnitsSliderWidget source, double newAngleDegrees) {
    ...
    if (externalListener != null) externalListener.onSliderMoving(source, newAngleDegrees);
  ...
  public void onSliderDoneMoving(EngineeringUnitsSliderWidget source, double newAngleDegrees) {
    ...
    if (externalListener != null) externalListener.onSliderDoneMoving(source, newAngleDegrees);
  }
}
