...
/**
 * Sample Skeleton for "jogTrainerWidget.fxml" Controller Class You can copy and paste this code
...
public class JogTrainerWidget extends Application implements IJInputEventListener {
  ...
  void configure(ActionEvent event) {
    ...
    new Thread(
            () -> {
              // linkval.setText((String) ConfigurationDatabase.getObject(paramsKey, "jogLink",
              // "x"));
              ...
              // rzval.setText((String) ConfigurationDatabase.getObject(paramsKey, "jogKinslider",
              // "slider"));
  ...
  void selectTraining(MouseEvent event) {
    if (TextField.class.isInstance(event.getSource())) selected = (TextField) event.getSource();
  }
  ...
  void initialize() {
    assert linkMinus != null
        : "fx:id=\"linkMinus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert linkPlus != null
        : "fx:id=\"linkPlus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert linkval != null
        : "fx:id=\"linkval\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert rotzMinus != null
        : "fx:id=\"rotzMinus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert rotzPlus != null
        : "fx:id=\"rotzPlus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert rzval != null
        : "fx:id=\"rzval\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert xminus != null
        : "fx:id=\"xminus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert xplus != null
        : "fx:id=\"xplus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert yminus != null
        : "fx:id=\"yminus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert yplus != null
        : "fx:id=\"yplus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert yval != null
        : "fx:id=\"yval\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert zminus != null
        : "fx:id=\"zminus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert zplus != null
        : "fx:id=\"zplus\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    assert zval != null
        : "fx:id=\"zval\" was not injected: check your FXML file 'jogTrainerWidget.fxml'.";
    ...
    Platform.runLater(
        () -> {
          ...
          zval.setText((String) ConfigurationDatabase.getObject(paramsKey, "jogKinz", "rz"));
          rzval.setText(
              (String) ConfigurationDatabase.getObject(paramsKey, "jogKinslider", "slider"));
        });
  }
