...
public class CreaturePhysicsWidget extends GridPane implements IMUUpdateListener {
    private Button runstop = new Button("Run", AssetFactory.loadIcon("Run.png"));
    private Button pauseresume = new Button("Pause", AssetFactory.loadIcon("Pause.png"));
    private Button step = new Button("Step", AssetFactory.loadIcon("Step.png"));
    private TextField msLoopTime = new TextField("200");
    ...
    public CreaturePhysicsWidget(MobileBase base) {
        ...
        step.setOnAction(event -> setTakestep(true));
                    ...
                    physicsThread = new Thread(() -> {
                        try {
                            while (!Thread.interrupted() && isRun()) {
                                while (!Thread.interrupted() && isPause() && !isTakestep()) {
