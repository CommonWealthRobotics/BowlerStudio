...
public class DockFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Image dockImage = new Image(org.dockfx.demo.DockFX.class.getResource("docknode.png").toExternalForm());
        ...
        //after this feel free to apply your own global stylesheet using the StyleManager class
    }
