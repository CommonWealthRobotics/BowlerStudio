...
public class BowlerConnectionMenu extends Application {
        ...
        new Thread(() -> {
            for (int i = 0; i < 3; i++) {
                ...
                try {
                    ...
                    port = portOptions.getSelectionModel().getSelectedItem();
    ...
    private void runconnectNetwork() {
        new Thread(() -> {
            int port;
            String ip = ipSelector.getSelectionModel().getSelectedItem();
        ...
        Platform.runLater(() -> {
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    prt = defaultPortNum;
                    Platform.runLater(() -> udpPort.setText(Integer.toString(defaultPortNum)));
                }
