...
public class FindTextWidget extends Application {
  ...
  void initialize() {
    assert matchCase != null
        : "fx:id=\"matchCase\" was not injected: check your FXML file 'findWidget.fxml'.";
    assert findBox != null
        : "fx:id=\"findBox\" was not injected: check your FXML file 'findWidget.fxml'.";
    assert replaceBox != null
        : "fx:id=\"replaceBox\" was not injected: check your FXML file 'findWidget.fxml'.";
