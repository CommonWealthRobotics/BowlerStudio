...
public class SalientTab extends AbstractBowlerStudioTab  {
	...
	public SalientTab(){}//default construtor
	public SalientTab(AbstractImageProvider pr, IObjectDetector dr) {
		this.provider = pr;
		this.setDetector(dr);
		initializeUI(pr);
	}
...
//									System.out.println("Got: " + data.size());
	...
	public IObjectDetector getDetector() {
		if(detector==null)
			setDetector(new SalientDetector());
		return detector;
	}
