        ...
        new IDeviceConnectionEventListener() {
          ...
          public void onDisconnect(BowlerAbstractDevice source) {
            ...
            if (source == pm && source != null) {
              ...
              // Not a bug, expected to ensure one device disconnects the rest of the dependent
              // devices
              //					System.err.println("Device type was "+source.getClass()+" named
              // "+source.getScriptingName()+" expected "+pm.getClass()+" named
              // "+pm.getScriptingName());
