...
public class WebTab extends Tab implements EventHandler<Event> {
  ...
  public WebTab(String title, String Url, boolean isTutorialTab)
      throws IOException, InterruptedException {

    if (isTutorialTab) {
      setGraphic(AssetFactory.loadIcon("Tutorial-Tab.png"));
    } else setGraphic(AssetFactory.loadIcon("Web-Tab.png"));
    ...
    if (title == null) myTab.setText("               ");
    else myTab.setText(title);
                    ...
                    Platform.runLater(
                        () -> {
                          if (!(newValue.intValue() < 100)) {
                            ...
                            //		    		//BowlerStudio.renderSplashFrame(splashGraphics,
                            // newValue.intValue());
                            //		            //splash.update();
                            //		    	}
    ...
    webEngine
        ...
        .addListener(
            new ChangeListener<String>() {
              @Override
              public void changed(
                  ObservableValue<? extends String> observable1, String oldValue, String newValue) {
        ...
        try {
          ...
          Platform.runLater(
              () -> {
                ...
                } else finishedLoadingScriptingWidget = true;
              });
  ...
  public void handle(Event event) {
    if (getScripting() != null) getScripting().stop();
  }
