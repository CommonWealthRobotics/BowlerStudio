...
public class WebTab extends Tab implements EventHandler<Event> {
    ...
    public WebTab(String title, String Url, boolean isTutorialTab) throws IOException, InterruptedException {
        ...
        webEngine.getLoadWorker().workDoneProperty().addListener((observableValue, oldValue, newValue) -> Platform.runLater(() -> {
...
//		    	}
        ...
        backButton.setOnAction(arg0 -> goBack());

        forwardButton.setOnAction(arg0 -> goForward());

        homeButton.setOnAction(arg0 -> loadUrl(Tutorial.getHomeUrl()));
        ...
        FxTimer.runLater(Duration.ofMillis(200), () -> goAction.handle(null));
    }
