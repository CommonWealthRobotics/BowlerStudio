...
public class FormacarumRover extends AbstractRobotDrive {
    private double steeringAngle = 0; //radians
    private ServoRotoryLink steering;
    private PIDChannel drive, lSteer, rSteer, bSteer;
    private boolean complexSteering = false;
