...
public class LocalSettingsPanel extends SettingsPanel {
  ...
  private void changeSlic3rLocation() {
    slic3rPath =
        FileSelectionFactory.GetFile(null, new ExtensionFilter("Slicer Executable", "*")).getPath();
  ...
  private JButton getBtnChangeSlicr() {
    if (btnChangeSlicr == null) {
      ...
      btnChangeSlicr.addActionListener(
          new ActionListener() {
  ...
  private JButton getBtnLoadDefaults() {
    if (btnLoadDefaults == null) {
      ...
      btnLoadDefaults.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                  ...
                  new Runnable() {
                    public void run() {
                      if (JOptionPane.showConfirmDialog(
                              null,
                              "This operation could be dangerous and break things.\n"
                                  + "You should restart NrConsole immediately after performing this action to avoid problems.",
                              "This could be risky...",
