...
public class DeviceConfigPanel extends JPanel {
  ...
  public void updateSettings() {
    ...
    slic3rSettingsPanel.setValue(
        0, new MachineSetting<Double>("NozzleDia", printer.getSlicer().getNozzle_diameter()));
    slic3rSettingsPanel.setValue(
        1, new MachineSetting<Double>("PCenterX", printer.getSlicer().getPrintCenter()[0]));
    slic3rSettingsPanel.setValue(
        2, new MachineSetting<Double>("PCenterY", printer.getSlicer().getPrintCenter()[1]));
    slic3rSettingsPanel.setValue(
        3, new MachineSetting<Double>("FilaDia", printer.getSlicer().getFilimentDiameter()));
    slic3rSettingsPanel.setValue(
        4, new MachineSetting<Double>("ExtMult", printer.getSlicer().getExtrusionMultiplier()));
    slic3rSettingsPanel.setValue(
        5, new MachineSetting<Integer>("PTemp", printer.getSlicer().getTempreture()));
    slic3rSettingsPanel.setValue(
        6, new MachineSetting<Integer>("BTemp", printer.getSlicer().getBedTempreture()));
    slic3rSettingsPanel.setValue(
        7, new MachineSetting<Double>("LayerHeight", printer.getSlicer().getLayerHeight()));
    slic3rSettingsPanel.setValue(
        8, new MachineSetting<Integer>("WallThickness", printer.getSlicer().getWallThickness()));
    slic3rSettingsPanel.setValue(
        9, new MachineSetting<Boolean>("UseSupport", printer.getSlicer().isUseSupportMaterial()));
    slic3rSettingsPanel.setValue(
        10, new MachineSetting<Double>("RetractLength", printer.getSlicer().getRetractLength()));
    slic3rSettingsPanel.setValue(
        11, new MachineSetting<Integer>("TravelSpd", printer.getSlicer().getTravilSpeed()));
    slic3rSettingsPanel.setValue(
        12, new MachineSetting<Integer>("PeriSpd", printer.getSlicer().getPerimeterSpeed()));
    slic3rSettingsPanel.setValue(
        13, new MachineSetting<Integer>("BridgeSpd", printer.getSlicer().getBridgeSpeed()));
    slic3rSettingsPanel.setValue(
        14, new MachineSetting<Integer>("GapFillSpd", printer.getSlicer().getGapFillSpeed()));
    slic3rSettingsPanel.setValue(
        15, new MachineSetting<Integer>("InfillSpd", printer.getSlicer().getInfillSpeed()));
    slic3rSettingsPanel.setValue(
        16,
        new MachineSetting<Integer>(
            "SupPeriSpdPcnt", printer.getSlicer().getSupportMaterialInterfaceSpeedPercent()));
    slic3rSettingsPanel.setValue(
        17,
        new MachineSetting<Integer>(
            "SmPeriSpdPcnt", printer.getSlicer().getSmallPerimeterSpeedPercent()));
    slic3rSettingsPanel.setValue(
        18,
        new MachineSetting<Integer>(
            "ExtPeriSpdPcnt", printer.getSlicer().getExternalPerimeterSpeedPercent()));
    slic3rSettingsPanel.setValue(
        19,
        new MachineSetting<Integer>(
            "SolidInfillSpdPcnt", printer.getSlicer().getSolidInfillSpeedPercent()));
    slic3rSettingsPanel.setValue(
        20,
        new MachineSetting<Integer>(
            "TopSolidInfillSpdPcnt", printer.getSlicer().getTopSolidInfillSpeedPercent()));
    slic3rSettingsPanel.setValue(
        21,
        new MachineSetting<Integer>(
            "SupportMatIntSpdPcnt", printer.getSlicer().getSupportMaterialSpeed()));
    slic3rSettingsPanel.setValue(
        22,
        new MachineSetting<Integer>(
            "FirstLayerSpdPcnt", printer.getSlicer().getFirstLayerSpeedPercent()));
  ...
  public void writeSettings() {
    ...
    Slic3r newSettings =
        new Slic3r(
            ...
            new double[] {
              slic3rSettingsPanel.getDoubleValue(1), slic3rSettingsPanel.getDoubleValue(2)
            },
    ...
    for (AxisPanel axisPanel : axisPanels) {
      ...
      printer
          .getDeltaDevice()
          .setLinkConfiguration(axisPanels.indexOf(axisPanel), axisPanel.getLink());
    }
  }
  ...
  private JButton getBtnReloadConfigs() {
    if (btnReloadConfigs == null) {
      ...
      btnReloadConfigs.addActionListener(
          new ActionListener() {
  ...
  private JButton getBtnWriteConfigs() {
    if (btnWriteConfigs == null) {
      ...
      btnWriteConfigs.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
              writeSettings();
            }
  ...
  private JTabbedPane getTabPnlSettings() {
    if (tabPnlSettings == null) {
      ...
      tabPnlSettings.addChangeListener(
          new ChangeListener() {
