...
public class AxisPanel extends JPanel {
  ...
  public AxisPanel(LinkConfiguration _thisLink) {
    ...
    viewPanel.add(
        setLinkType = new SettingsListItem("Link Type", thisLink.getTypeEnum().getName()),
        "cell 0 1");
    FlowLayout flowLayout_1 = (FlowLayout) setLinkType.getLayout();
    flowLayout_1.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setHardwareIndex = new SettingsListItem("Hardware Index", thisLink.getHardwareIndex()),
        "cell 0 2");
    FlowLayout flowLayout_2 = (FlowLayout) setHardwareIndex.getLayout();
    flowLayout_2.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setHomingTicksPerSecond =
            new SettingsListItem("Homing Ticks per Second", thisLink.getHomingTicksPerSecond()),
        "cell 0 3");
    FlowLayout flowLayout_3 = (FlowLayout) setHomingTicksPerSecond.getLayout();
    flowLayout_3.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setIndexLatch = new SettingsListItem("Index Latch", thisLink.getIndexLatch()), "cell 0 4");
    ...
    viewPanel.add(
        setLowerLimit = new SettingsListItem("Lower Limit", thisLink.getLowerLimit()), "cell 0 8");
    FlowLayout flowLayout_8 = (FlowLayout) setLowerLimit.getLayout();
    flowLayout_8.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setUpperLimit = new SettingsListItem("Upper Limit", thisLink.getUpperLimit()), "cell 0 9");
    FlowLayout flowLayout_9 = (FlowLayout) setUpperLimit.getLayout();
    flowLayout_9.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setLowerVelocity = new SettingsListItem("Lower Velocity", thisLink.getLowerVelocity()),
        "cell 0 10");
    FlowLayout flowLayout_10 = (FlowLayout) setLowerVelocity.getLayout();
    flowLayout_10.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setUpperVelocity = new SettingsListItem("Upper Velocity", thisLink.getUpperVelocity()),
        "cell 0 11");
    FlowLayout flowLayout_11 = (FlowLayout) setUpperVelocity.getLayout();
    flowLayout_11.setAlignment(FlowLayout.LEFT);
    viewPanel.add(
        setLinkIndex = new SettingsListItem("Link Index", thisLink.getLinkIndex()), "cell 0 12");
  ...
  private void reloadSettings() {
    ...
    setHomingTicksPerSecond.loadValues(
        "Homing Ticks per Second", thisLink.getHomingTicksPerSecond());
