...
public class PIDControlWidget extends JPanel implements IPIDEventListener, ActionListener {
        ...
        .addActionListener(
            new ActionListener() {
              ...
              public void actionPerformed(ActionEvent arg0) {
                ...
                setPID(
                    p, i, d, vp, vd, l, useLatch.isSelected(), stopOnLatch.isSelected(), up, low);
  ...
  private void graphVals() {
    if (graph != null) graph.addEvent(setpointValue, getPositionValue());
  }
  ...
  public void onPIDLimitEvent(PIDLimitEvent e) {
    if (e.getGroup() == getGroup()) {
      ...
      setInternalSetpoint((int) e.getValue());
      setPositionDisplay((int) e.getValue());
      // }
    }
  }
