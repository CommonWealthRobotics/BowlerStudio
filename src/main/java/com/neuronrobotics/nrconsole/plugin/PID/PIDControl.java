  ...
  public void initializeUI(BowlerAbstractDevice pm) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(
          null, "DyIO Firmware is out of date", "DyPID ERROR", JOptionPane.ERROR_MESSAGE);
      return;
    }
    ...
    for (int i = 0; i < initVals.length; i++) {
      ...
      try {
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(
            null, "Failed to create a PID widget", "DyPID ERROR", JOptionPane.ERROR_MESSAGE);
        return;
      }
