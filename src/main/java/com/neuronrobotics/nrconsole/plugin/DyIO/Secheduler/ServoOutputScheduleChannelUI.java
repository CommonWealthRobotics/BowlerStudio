...
public class ServoOutputScheduleChannelUI extends JPanel
    implements IServoPositionUpdateListener, ActionListener, ISchedulerListener {
      ...
      new ChangeListener() {
        ...
        public void stateChanged(ChangeEvent e) {
          ...
          if (useSlider.isSelected()) {
            flush();
            if (!getCb().isPlaying()) channel.flush();
          } else {
