...
public class SchedulerControlBar extends JPanel implements ISchedulerListener {
  ...
  private void pause() {
    ...
    for (ActionListener a : pauseListeners) a.actionPerformed(null);
  }
  ...
  private void getFile() {
    setAudioFile(
        FileSelectionFactory.GetFile(
            mp3File == null ? ScriptingEngine.getWorkspace() : mp3File,
  ...
  public void addPauseListener(ActionListener actionListener) {
    if (!pauseListeners.contains(actionListener)) pauseListeners.add(actionListener);
  }

  public void addPlayListener(ActionListener actionListener) {
    if (!playListeners.contains(actionListener)) playListeners.add(actionListener);
  }
