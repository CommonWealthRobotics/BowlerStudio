...
public class SchedulerGui extends JPanel {
  ...
  private void rmChannel(int num) {
    ...
    for (ServoOutputScheduleChannelUI so : outputs) {
      if (so.getChannelNumber() == num) s = so;
    }
    if (s == null) return;
  ...
  private void getFile() {
    if (configFile == null) configFile = ScriptingEngine.getWorkspace();
    configFile =
        FileSelectionFactory.GetFile(
            configFile, new ExtensionFilter("Sequence XML", "*.xml", "*.XML"));
  }
  ...
  public boolean setConnection(BowlerAbstractDevice connection) {
          ...
          public void actionPerformed(ActionEvent e) {
            try {
              ...
              JOptionPane.showMessageDialog(
                  null,
                  "Failed to select channel, " + ex.getMessage(),
                  "Bowler ERROR",
    ...
    removeChannel.addActionListener(
        new ActionListener() {
          public void actionPerformed(ActionEvent e) {
    ...
    saveConfiguration.addActionListener(
        new ActionListener() {
    ...
    loadConfiguration.addActionListener(
        new ActionListener() {
