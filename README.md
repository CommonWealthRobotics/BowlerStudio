...
[videoInput](http://muonics.net/school/spring05/videoInput/), [ARToolKitPlus](http://studierstube.icg.tugraz.at/handheld_ar/artoolkitplus.php), and [flandmark](http://cmp.felk.cvut.cz/~uricamic/flandmark/)), [CHDK-PTP-Java](https://github.com/acamilo/CHDK-PTP-Java),
[Jinput](https://github.com/jinput/jinput), 
[motej](http://motej.sourceforge.net/), [Usb4Java](https://github.com/usb4java/usb4java), 
